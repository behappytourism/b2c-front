...
const ListingCarDetailPage: FC<ListingCarDetailPageProps> = ({}) => {
  ...
  const fetchVisaDetails = async () => {
    try {
      const nationality = await fetch(`${process.env.NEXT_PUBLIC_SERVER_URL}/api/v1/visa/type/uae-visa/all/india`)
  ...
  console.log(visaDetails, "visa details")
    ...
    return (
      <div className="listingSectionSidebar__wrap shadow-xl">
        ...
        <input
           ...
           // ref={inputRef}
          />
          <span className="block mt-0.5 text-sm text-neutral-400 font-light ">Name</span>
          </div>
          <div className="p-2 rounded-xl border mb-2">
             <input
            className={`block w-full bg-transparent border-none focus:ring-0 p-0 focus:outline-none focus:placeholder-neutral-300 xl:text-lg font-semibold placeholder-neutral-800 dark:placeholder-neutral-200 truncate capitalize`}
           ...
           // ref={inputRef}
          />
          <span className="block mt-0.5 text-sm text-neutral-400 font-light ">Email</span>
          </div>
          <div className="p-2 rounded-xl border mb-2">
             <input
            className={`block w-full bg-transparent border-none focus:ring-0 p-0 focus:outline-none focus:placeholder-neutral-300 xl:text-lg font-semibold placeholder-neutral-800 dark:placeholder-neutral-200 truncate capitalize`}
           ...
           // ref={inputRef}
          />
          <span className="block mt-0.5 text-sm text-neutral-400 font-light ">Whatsapp Number</span>
          </div>
          <div className="p-2 rounded-xl border  mb-2">
             <input
            className={`block w-full bg-transparent border-none focus:ring-0 p-0 focus:outline-none focus:placeholder-neutral-300 xl:text-lg font-semibold placeholder-neutral-800 dark:placeholder-neutral-200 truncate capitalize`}
           ...
           // ref={inputRef}
          />
          <span className="block mt-0.5 text-sm text-neutral-400 font-light ">Nationality</span>
          </div>
        </form>
        ...
        {/* SUBMIT */}
        <ButtonPrimary >Inquiry Now</ButtonPrimary>
      </div>
    );
  };
    ...
    <div className={` nc-ListingCarDetailPage `}>
      ...
      <header className="rounded-md sm:rounded-xl">
        <div className="relative grid grid-cols-4 gap-1 sm:gap-2">
          <div
            className="col-span-4 h-[300px] relative rounded-md sm:rounded-xl overflow-hidden cursor-pointer"
            onClick={handleOpenModalImageGallery}
          >
            <Image
              fill
              src="/_next/static/images/visa/visaPage.jpg"
              alt="photo 0"
          ...
          {/*  */}
          <div
            className="col-span-1 row-span-2 hidden relative rounded-md sm:rounded-xl overflow-hidden cursor-pointer"
            onClick={handleOpenModalImageGallery}
          >
            {/* <Image
              fill
          ...
          {PHOTOS.filter((_, i) => i >= 2 && i < 4).map((item, index) => (
            <div
              key={index}
              className={`relative rounded-md hidden sm:rounded-xl overflow-hidden ${
                index >= 2 ? "block" : ""
              }`}
            >
