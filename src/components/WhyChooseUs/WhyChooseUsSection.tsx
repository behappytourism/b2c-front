  ...
  return (
   ...
   <div className="flex gap-4">
      <div className="flex flex-col gap-4 pt-20">
        <div className="border rounded-2xl min-w-[300px] relative overflow-hidden cursor-pointer max-w-[300px] min-h-[300px]">
            <Image src={wcu1} height={1000} width={1000} alt="why choose us #1" />
        ...
        <div className="border rounded-2xl min-w-[300px] cursor-pointer relative overflow-hidden max-w-[300px] min-h-[200px]">
        <Image src={wcu2} height={1000} width={1000} alt="why choose us #1" />
        <span className="opacity-0 w-full absolute right-10 hover:opacity-100 inset-0 bg-black bg-opacity-40 transition-all duration-300 group-hover:transition-all group-hover:duration-300"></span>
      ...
      <div className="flex flex-col gap-4">
        <div className="border rounded-2xl min-w-[300px] cursor-pointer relative overflow-hidden max-w-[300px] min-h-[200px]">
        <Image src={wcu3} height={1000} width={1000} alt="why choose us #1" />
        <span className="opacity-0 w-full absolute right-10 hover:opacity-100 inset-0 bg-black bg-opacity-40 transition-all duration-300 group-hover:transition-all group-hover:duration-300"></span>
        ...
        <div className="border rounded-2xl min-w-[300px] cursor-pointer relative overflow-hidden max-w-[300px] min-h-[300px]">
        <Image src={wcu4} height={1000} width={1000} alt="why choose us #1" />
        <span className="opacity-0 w-full absolute right-10 hover:opacity-100 inset-0 bg-black bg-opacity-40 transition-all duration-300 group-hover:transition-all group-hover:duration-300"></span>
...
<div className="border rounded-2xl min-w-[300px] cursor-pointer relative overflow-hidden max-w-[300px] min-h-[200px]">
        <Image src={wcu5} height={1000} width={1000} alt="why choose us #1" />
        <span className="opacity-0 w-full absolute right-10 hover:opacity-100 inset-0 bg-black bg-opacity-40 transition-all duration-300 group-hover:transition-all group-hover:duration-300"></span>
        <div className="absolute text-white z-30 bottom-3 left-4">
                <p className="text-2xl font-semibold">Best Price Guaranteed                </p>
                <p>Price match within 48 hours of order confirmation - guaranteed!</p>
            </div>
        </div>
      </div>
